...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        AclService aclService = Holders.applicationContext.getBean(MyAclService)
...
//        }
        ...
        AclEntry.withTransaction {
            ...
            SpringSecurityUtils.doWithAuth("zhang3") {
                ...
                aclUtilService.addPermission(orgZj, "li4", MyPermission.ADMINISTRATION)
                aclUtilService.addPermission(orgZj, "li4", MyPermission.READ)

                aclService.createAcl(new ObjectIdentityImpl(orgHz))

                aclService.createAcl(new ObjectIdentityImpl(orgHn))
                aclUtilService.addPermission(orgHn, "li4", MyPermission.ADMINISTRATION)
                aclUtilService.addPermission(orgHn, "li4", MyPermission.READ)

                aclService.createAcl(new ObjectIdentityImpl(orgZz))

                aclService.createAcl(new ObjectIdentityImpl(orgSd))
                aclUtilService.addPermission(orgSd, "li4", MyPermission.ADMINISTRATION)
                aclUtilService.addPermission(orgSd, "li4", MyPermission.READ)
