...
//        println "getMNSAccessKeyId     : " + ServiceSettings.getMNSAccessKeyId()
//        println "getMNSAccessKeySecret : " + ServiceSettings.getMNSAccessKeySecret()
//        println "getMNSAccountEndpoint : " + ServiceSettings.getMNSAccountEndpoint()
        ...
        try {
            CloudQueue queue = client.getQueueRef("btpka3");
            for (int i = 0; i < 2; i++) {
