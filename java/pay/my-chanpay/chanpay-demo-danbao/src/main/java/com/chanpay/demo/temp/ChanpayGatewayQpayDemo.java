...
public class ChanpayGatewayQpayDemo {
   ...
   /**
     * 2.24 单笔订单担保交易接口cjt_create_ensure_trade	
     */
    public void cjt_create_ensure_trade	() {

        Map<String, String> origMap = new HashMap<String, String>();
        // 2.1 基本参数
        origMap.put("service", "cjt_create_ensure_trade	");// 支付的接口名
        origMap.put("version", "1.0");
        origMap.put("partner_id", "200000400007"); // 畅捷支付分配的商户号
        origMap.put("_input_charset", charset);// 字符集
        
        origMap.put("request_no", "6741334835157966");
		origMap.put("trade_amount", "75.00");
		origMap.put("ensure_amount", "50.00");
		origMap.put("pay_method", "2");
		origMap.put("out_trade_no", "6741334835157966");
		origMap.put("is_anonymous", "Y");
		origMap.put("order_amount", "75.00");
	 ...
	 /**
     * 2.25担保交易确认结算（分润）接口cjt_create_settle
     */
    public void cjt_create_settle() {
        ...
        origMap.put("partner_id", "200000400007"); // 畅捷支付分配的商户号
        origMap.put("_input_charset", charset);// 字符集
        origMap.put("service", "cjt_create_settle");// 支付的接口名
        // 2.19快捷api确认
        origMap.put("out_trade_no", "4a7841eaa2e34fff821c0eb451acb137");// 订单号
        origMap.put("orig_outer_trade_no", "4a7841eaa2e34fff821c0eb451acb137");

        this.gatewayPost(origMap, charset, MERCHANT_PRIVATE_KEY);
    }

	/**
     * 2.31 单笔订单担保交易快捷支付接口cjt_quick_ensure_trade
     */
    public void cjt_quick_ensure_trade() {

        Map<String, String> origMap = new HashMap<String, String>();
        // 2.1 基本参数
        origMap.put("service", "cjt_quick_ensure_trade");// 支付的接口名
        origMap.put("version", "1.0");
        origMap.put("partner_id", "200000400007"); // 畅捷支付分配的商户号
        origMap.put("_input_charset", charset);// 字符集
		...
		origMap.put("trade_amount", "75.00");
		origMap.put("out_trade_no", "6741334835157966");
		origMap.put("ensure_amount", "75.00");
		origMap.put("sell_id_type", "MEMBER_ID");
		origMap.put("buyer_ip", "202.114.12.45");
		origMap.put("card_type", "CC");
		origMap.put("pay_type", "B");
		origMap.put("bank_code", "CCB");
		origMap.put("payer_name", this.encrypt("测试01", MERCHANT_PUBLIC_KEY, charset));
        origMap.put("payer_card_no", this.encrypt("6214830215878947", MERCHANT_PUBLIC_KEY, charset));
        origMap.put("id_number", this.encrypt("152801111111111111", MERCHANT_PUBLIC_KEY, charset));
        origMap.put("phone_number", this.encrypt("13511111111", MERCHANT_PUBLIC_KEY, charset));
	...
	/**
     * 2.34 批量订单担保交易快捷支付接口cjt_quick_batch_ensure_trade
     */
    public void cjt_quick_batch_ensure_trade() {

        Map<String, String> origMap = new HashMap<String, String>();
        // 2.1 基本参数
        origMap.put("service", "cjt_quick_batch_ensure_trade");// 支付的接口名
        origMap.put("version", "1.0");
        origMap.put("partner_id", "200000400007"); // 畅捷支付分配的商户号
        origMap.put("_input_charset", charset);// 字符集

		origMap.put("trade_amount", "75.00");
		origMap.put("prodInfo_list", "[{'out_trade_no':'2016121509555626218968025884','product_name':'','order_amount':'1.00','ensure_amount':'1.00','sell_id':'','sell_id_type':'UID','sell_mobile':'','action_desc':'','produc_url':'','order_time':'','notify_url':'','expired_time':''}]");
		origMap.put("sell_id_type", "MEMBER_ID");
		origMap.put("buyer_ip", "202.114.12.45");
		origMap.put("card_type", "CC");
		origMap.put("pay_type", "B");
    ...
    /**
     * 2.35批量快捷支付交易确认接口cjt_batch_quick_payment_confirm
     */
    public void cjt_batch_quick_payment_confirm() {
        ...
        origMap.put("partner_id", "200000400007"); // 畅捷支付分配的商户号
        origMap.put("_input_charset", charset);// 字符集
        origMap.put("service", "cjt_batch_quick_payment_confirm");// 支付的接口名
        // 2.19快捷api确认
        origMap.put("out_trade_no", "4a7841eaa2e34fff821c0eb451acb137");// 订单号
        origMap.put("verification_code", "123456");// 短信验证码
