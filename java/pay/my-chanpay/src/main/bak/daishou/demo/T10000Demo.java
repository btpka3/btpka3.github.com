...
public class T10000Demo extends BaseParameter {
	...
	public void send() {
		...
		map.put("AcctNo", ChanPayUtil.encrypt("6217000010000000000", BaseConstant.MERCHANT_PUBLIC_KEY, BaseConstant.CHARSET)); // 对手人账号(此处需要用真实的账号信息)
		map.put("AcctName", ChanPayUtil.encrypt("畅捷支付", BaseConstant.MERCHANT_PUBLIC_KEY, BaseConstant.CHARSET)); // 对手人账户名称
		map.put("TransAmt", "1");
