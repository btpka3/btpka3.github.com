 ...
 *
 */
public class ChanpayWxComPayReq extends Req {

    public ChanpayWxComPayReq() {
        this.setService(CpScanApi.S_chanpayWxComPay);
    }
    ...
    public boolean equals(Object o) {
        ...
        ChanpayWxComPayReq that = (ChanpayWxComPayReq) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), outTradeNo, mchId, subMchId, tradeType, bankCode, deviceInfo, currency, tradeAmount, ensureAmount, goodsName, tradeMemo, subject, orderStartTime, orderEndTime, limitCreditPay, notifyUrl, spBillCreateIp, splitList, ext);
    }
}
