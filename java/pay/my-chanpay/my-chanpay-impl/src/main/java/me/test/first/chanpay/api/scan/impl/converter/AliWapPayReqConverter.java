 ...
 */
@Component
public class AliWapPayReqConverter implements Converter<AliWapPayReq, Map<String, String>> {
    ...
    @Override
    public Map<String, String> convert(AliWapPayReq src) {
        ...
        List<AliWapPayReq.Split> splitList = src.getSplitList();
        if (splitList != null) {
            try {
