 ...
 */
@Component
public class MerchantWxComPayReqConverter implements Converter<MerchantWxComPayReq, Map<String, String>> {
    ...
    @Override
    public Map<String, String> convert(MerchantWxComPayReq src) {
        ...
        List<MerchantWxComPayReq.Split> splitList = src.getSplitList();
        if (splitList != null) {
            try {
