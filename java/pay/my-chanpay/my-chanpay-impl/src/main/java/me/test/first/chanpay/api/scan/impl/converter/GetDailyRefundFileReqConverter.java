 ...
 */
@Component
public class GetDailyRefundFileReqConverter implements Converter<GetDailyRefundFileReq, Map<String, String>> {
    ...
    @Override
    public Map<String, String> convert(GetDailyRefundFileReq src) {
