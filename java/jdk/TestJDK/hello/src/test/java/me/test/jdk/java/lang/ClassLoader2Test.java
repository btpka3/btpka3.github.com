...
public class ClassLoader2Test {
    ...
    public void test01() throws Exception {
        // 3.14.0
        System.out.println("111: " + StringUtils.class.getProtectionDomain().getCodeSource().getLocation());
        File jarFile = new File(System.getProperty("user.home")
                + "/.m2/repository/org/apache/commons/commons-lang3/3.0/commons-lang3-3.0.jar");

        {
            ...
            System.out.println("222: " + clazz.getProtectionDomain().getCodeSource().getLocation());
        ...
        }
        {
            ...
            Class clazz = Class.forName("org.apache.commons.lang3.StringUtils", true, cl);
            // 3.0
            System.out.println("333: " + clazz.getProtectionDomain().getCodeSource().getLocation());

        }
        // 3.14.0
        System.out.println("444: " + StringUtils.class.getProtectionDomain().getCodeSource().getLocation());
    }
