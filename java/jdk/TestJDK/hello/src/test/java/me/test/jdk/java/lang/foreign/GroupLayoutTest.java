...
public class GroupLayoutTest {
    ...
    public void structArray() {
        try (Arena arena = Arena.ofConfined()) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                long xOffset = baseOffset + pointLayout.byteOffset(MemoryLayout.PathElement.groupElement("x"));
                long yOffset = baseOffset + pointLayout.byteOffset(MemoryLayout.PathElement.groupElement("y"));
    ...
    public void structWithPointer() {
        ...
        GroupLayout nodeLayout =
                MemoryLayout.structLayout(ValueLayout.JAVA_INT.withName("value"), ValueLayout.ADDRESS.withName("next"));
