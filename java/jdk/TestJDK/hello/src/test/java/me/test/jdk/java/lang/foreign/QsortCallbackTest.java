...
public class QsortCallbackTest {
    ...
    public void qsortWithJavaCallback() throws Throwable {
        ...
        MethodHandle javaComparator = MethodHandles.lookup()
                .findStatic(
        ...
        MemorySegment comparatorStub = linker.upcallStub(javaComparator, comparatorDesc, Arena.global());
    ...
    public void qsortStringsWithJavaCallback() throws Throwable {
        ...
        // 5. 定义比较函数的描述符
        FunctionDescriptor comparatorDesc =
    ...
    private static String readCString(MemorySegment segment) {
        ...
        MemorySegment safeSegment = segment.byteSize() == 0 ? segment.reinterpret(Integer.MAX_VALUE) : segment;
    ...
    public void qsortDescendingWithJavaCallback() throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            qsortHandle.invokeExact(arraySegment, (long) arraySize, ValueLayout.JAVA_INT.byteSize(), comparatorStub);
