...
public class IntStreamTest {
    public static void main(String[] args) {
        ...
        // 注意: 2L != 2
        System.out.println(
                "list distinct : " + Arrays.toString(list.stream().distinct().toArray()));
    ...
    static void testParallel1(int bigNum) {
        ...
        IntStream.range(0, bigNum).parallel().filter(IntStreamTest::isPrime).forEach(System.out::println);
        long end1 = System.currentTimeMillis();
        System.out.println("================================================= ");

        long start2 = System.currentTimeMillis();
        IntStream.range(0, bigNum).filter(IntStreamTest::isPrime).forEach(System.out::println);
    ...
    static void testParallel2(int bigNum) {
        ...
        long start2 = System.currentTimeMillis();
        IntStream.range(0, bigNum).filter(IntStreamTest::isPrime).sorted().forEach(System.out::println);
        long end2 = System.currentTimeMillis();
