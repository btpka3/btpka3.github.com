...
public class Film extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Short> FILM_ID = createField(DSL.name("film_id"), SQLDataType.SMALLINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>sakila.film.title</code>.
     */
    public final TableField<Record, String> TITLE = createField(DSL.name("title"), SQLDataType.VARCHAR(128).nullable(false), this, "");
     ...
     */
    public final TableField<Record, LocalDate> RELEASE_YEAR = createField(DSL.name("release_year"), SQLDataType.LOCALDATE, this, "");

    /**
     * The column <code>sakila.film.language_id</code>.
     */
    public final TableField<Record, Byte> LANGUAGE_ID = createField(DSL.name("language_id"), SQLDataType.TINYINT.nullable(false), this, "");

    /**
     * The column <code>sakila.film.original_language_id</code>.
     */
    public final TableField<Record, Byte> ORIGINAL_LANGUAGE_ID = createField(DSL.name("original_language_id"), SQLDataType.TINYINT, this, "");

    /**
     * The column <code>sakila.film.rental_duration</code>.
     */
    public final TableField<Record, Byte> RENTAL_DURATION = createField(DSL.name("rental_duration"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("3", SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>sakila.film.rental_rate</code>.
     */
    public final TableField<Record, BigDecimal> RENTAL_RATE = createField(DSL.name("rental_rate"), SQLDataType.DECIMAL(4, 2).nullable(false).defaultValue(DSL.inline("4.99", SQLDataType.DECIMAL)), this, "");
     ...
     */
    public final TableField<Record, BigDecimal> REPLACEMENT_COST = createField(DSL.name("replacement_cost"), SQLDataType.DECIMAL(5, 2).nullable(false).defaultValue(DSL.inline("19.99", SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>sakila.film.rating</code>.
     */
    public final TableField<Record, FilmRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR(5).defaultValue(DSL.inline("G", SQLDataType.VARCHAR)).asEnumDataType(com.github.btpka3.first.spring.jooq.domain.enums.FilmRating.class), this, "");

    /**
     * The column <code>sakila.film.special_features</code>.
     */
    public final TableField<Record, String> SPECIAL_FEATURES = createField(DSL.name("special_features"), SQLDataType.VARCHAR(54), this, "");
