...
public class Category extends TableImpl<CategoryRecord> {
     ...
     */
    public final TableField<CategoryRecord, Byte> CATEGORY_ID = createField(DSL.name("category_id"), SQLDataType.TINYINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<CategoryRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public Identity<CategoryRecord, Byte> getIdentity() {
        return (Identity<CategoryRecord, Byte>) super.getIdentity();
    }
