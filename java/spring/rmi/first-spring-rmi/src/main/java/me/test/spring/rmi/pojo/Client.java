...
public class Client {
	...
	public static void main(String[] args) throws Exception {
		ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext(
				"classpath:/pojo/client-context.xml");
		ctx.start();
		...
		myInterface.execute(clientData,
				RMIUtil.registerAndExport(clientCallback, Runnable.class));
		...
		System.out.println("CLIENT: invoke server callback function");
		 Runnable  serverCallback = myInterface.getServerCallback();
		 // FIXME : sometimes throws java.lang.reflect.UndeclaredThrowableException
		 serverCallback.run();
