 ...
 *
 * Thanks to Alex Soto (@alexsotob) for getting this started and implementing the initial prototype version.
 *
...
public class QueryDslJdbcTemplate implements QueryDslJdbcOperations {
    ...
    public SQLQuery newSqlQuery() {
        ...
        return new SQLQuery(DataSourceUtils.getConnection(jdbcTemplate.getDataSource()), this.dialect);
    }
