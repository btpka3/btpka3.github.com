package me.test.first.spring.boot.cxf.first.spring.boot.gorm.mongo.controller

import me.test.first.spring.boot.cxf.first.spring.boot.gorm.mongo.domain.City
import me.test.first.spring.boot.cxf.first.spring.boot.gorm.mongo.domain.Street
