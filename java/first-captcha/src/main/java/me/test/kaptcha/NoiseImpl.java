...
/**
 * The default implementation of {@link com.google.code.kaptcha.NoiseProducer}, adds a noise on an
 * image.
 * 基于kaptcha的DefaultNoise，干扰线宽度+2。
 */
public class NoiseImpl extends Configurable implements NoiseProducer
{
			...
			float factorTwo, float factorThree, float factorFour)
	{
		...
		{
			if (i < 3)
				graph.setStroke(new BasicStroke(0.9f * (4 - i)+2));
