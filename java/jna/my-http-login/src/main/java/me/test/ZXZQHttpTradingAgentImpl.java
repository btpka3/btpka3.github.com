 ...
 */
package com.shengrensoft.stock.ss03.batch.agent.agent016;
...
import com.shengrensoft.stock.ss03.web.common.service.AgentException;
 ...
 */
public class ZXZQHttpTradingAgentImpl implements TradingAgent {
    ...
    public String sellInNormal(
            ...
            String stkCode,
            Long amount,
            Integer price) throws AgentException {
    ...
    public String revoke(
            ...
            Long accountNo,
            String stkCode,
            String commitNo) throws AgentException {
    ...
    public List<UserAccountHoldingStatusRec> getHoldingStatusRecs(
            String userId,
            Long accountNo) throws AgentException{
    ...
    public void connect(
            String userId,
            Long accountNo,
            java.util.Map authInfo) throws AgentException {
        ...
        // 资金账户密码错误    
            ...
            throw new AgentException("R0303.E001", "用户名或密码错误。");
        ...
        // 其它错误    
            ...
            throw new AgentException("R0303.E003", "与证券公司连接错误。");
     ...
     * @return 错误代码
     */
    public String login() throws AgentException {
     ...
     * 创建备注信息。 
     */
    private void createOpstation(java.util.Map authInfo) {
    ...
    public List<UserAccountCommissionRec> getHistoryCommissionRecs(
            ...
            Long arg1,
            String arg2,
            String arg3) throws AgentException {
        return null;
    }
    ...
    public List<UserAccountTradedRec> getHistoryTradedRecs(
            ...
            Long accountNo,
            String dateFrom,
            String dateTo) throws AgentException {
        return null;
    }
    ...
    public String buyBorrInCredit(
            ...
            String arg2,
            Long arg3,
            Integer arg4) throws AgentException {
        return null;
    }
    ...
    public Long getBorrBuyingEnableAmount(
            ...
            Long arg1,
            String arg2,
            Integer arg3) throws AgentException {
        return null;
    }
    ...
    public UserAccountCreditInfo getCreditAssetsStatusRec(
            String arg0,
            Long arg1) throws AgentException {
        return null;
    }
